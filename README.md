...
Main screen of the application (inventory CRUD, business operations, KPI cards, and filtering).
...
## Version Notes
- `v1.2.0`: Refreshed UI presentation with KPI cards, filtering, improved screenshots, and clearer code comments/docstrings.
